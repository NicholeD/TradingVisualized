...
//        List<Fish> fish3 = JsonFishConverter.convertToFishFromFile(new File("C:\\Users\\ajben\\kenzie\\ata-capstone-project-tv\\Frontend\\src\\exe\\TV_Data\\data.txt"));
//        System.out.println(fish3);
//        System.out.println(JsonFishConverter.convertToJson(fish3));
//        JsonFishConverter.convertToJsonFile(fish3, new File("C:\\Users\\ajben\\kenzie\\ata-capstone-project-tv\\Frontend\\src\\exe\\TV_Data\\data.txt"));
//        System.out.println(JsonFishConverter.convertToFishFromFile(new File("C:\\Users\\ajben\\kenzie\\ata-capstone-project-tv\\Frontend\\src\\exe\\TV_Data\\data.txt")));
    }
}
